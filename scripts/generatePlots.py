...
def create_bytes_graph(probability, nbytes):
    ...
    ax.set_xticklabels(('50 nós', '100 nós', '150 nós', '200 nós'), fontsize='medium')
    ax.legend((rects1[0], rects2[0], rects3[0]), ("Plumtree Causal", "Flood", "Pull Periódico"), fontsize='medium')
    plt.yscale("log")
    plt.ylabel('Número de Bytes Transmitidos', fontsize='large')
...
def create_latency_graph(probability, latency):
    ...
    ax.set_xticklabels(('50 nós', '100 nós', '150 nós', '200 nós'), fontsize='medium')
    ax.legend((rects1[0], rects2[0], rects3[0]), ("Plumtree Causal", "Flood", "Pull Periódico"), fontsize='medium')
    plt.ylabel('Latência Média de Difusão (ms)', fontsize='large')
...
def create_total_dupes_graph(probability, plumtree, flood, pull):
    ...
    ax.legend((rects1[0], rects2[0], rects3[0]), ("Plumtree Causal", "Flood", "Pull Periódico"), fontsize='medium')
    plt.yscale("log")
    plt.ylabel('Mensagens Duplicadas Recebidas', fontsize='large')
