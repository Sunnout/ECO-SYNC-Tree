...
HEADER = "avg_broadcast_latency, avg_bytes_received, avg_bytes_transmitted, avg_sent_vc, avg_sent_sync_ops," \
         " avg_received_vc, avg_received_sync_ops, avg_sent_flood, avg_sent_send_vc, avg_sent_sync_flood," \
         " avg_received_flood, avg_received_dupes_flood, avg_received_send_vc, avg_received_sync_flood," \
...
def parse_logs_flood(n_nodes, runs, payload, probability):
    n_runs = len(runs)
    ...
    results = int(avg_broadcast_latency), avg_bytes_received, avg_bytes_transmitted, \
